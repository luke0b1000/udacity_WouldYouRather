let users = {
    sarahedo: {
        id: 'sarahedo',
        name: 'Sarah Edo',
        avatarURL: require('./../assets/avatar2.jpg'),
        answers: {
    ...
    tylermcginnis: {
        id: 'tylermcginnis',
        name: 'Tyler McGinnis',
        avatarURL: require('./../assets/avatar1.jpg'),
        answers: {
    ...
    johndoe: {
        id: 'johndoe',
        name: 'John Doe',
        avatarURL: require('./../assets/avatar3.jpg'),
        answers: {
        ...
        setTimeout(() => {
            questions = {
                ...
                [finalComment.qid]: {
                    ...
                    comments: questions[finalComment.qid].comments.concat([
                        commentId,
                    ]),
                },
            };
